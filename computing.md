...
- <https://blog.verygoodsoftwarenotvirus.ru/posts/babys-first-aws/> -
  ...
  household for the week. ... I've sort of over-engineered it on purpose
  in the spirit of learning. ...

  I want to run it in AWS. To call it cargo culting is likely fair, but
  every single company I've ever worked for has used AWS. ...
  it's bound to be a valuable skill for a software engineer to have."
