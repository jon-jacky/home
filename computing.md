...
- <https://sqlite.org/lpc2019/doc/trunk/briefing.md> - SQLite on Linux
  ...
  "SQLite is not like pther database engines. SQLite is not a separate
...
- <http://akkartik.name/illich.pdf> - *Tools for Conviviality* by Ivan Illich
  (1973), Introduction p. 5, Ch 2 Convivial Reconstruction, p. 13.
  ...
  ... I will suggest ... how modern science and technology can be used to
  endow human activity with unprecedented effectiveness. This reversal
  would ... give priority to ... the one resource that is almost equally
