...
- <https://basicengine.org/> - "The BASIC Engine is a very low-cost
  ...
  Euros in parts. ... a stand-alone computer programmable in the BASIC
  language."  <https://basicengine.org/history.html> - "The VS23S010D-L
  ...is a static RAM chip ... (that) comes with a video
  controller. ... It comes with 128 kB, some or all of which can be
  used as a frame buffer ... has a "block move" feature, more commonly
  known as a blitter. It allows you to copy sections of video memory
  ... provides a dramatic performance boost in ... text screen
  scrolling and rendering of tiled backgrounds."  via
  <https://www.metafilter.com/175123/62984-bytes-free.> Compare to
  Uzebox below.
...
- <http://www.vulture.com/article/100-most-influential-pages-comic-book-history.html>
  - "We have set out to trace the evolution of American comics by
...
- <http://nymag.com/selectall/2018/04/an-apology-for-the-internet-from-the-people-who-built-it.html>
  - "To understand what went wrong — how the Silicon Valley dream of
...
- <https://www.metafilter.com/173509/Take-me-for-a-walk-in-the-morning-dew-my-honey>
  - "Morning Dew is a post-nuclear protest song, written in 1961 by
...
Can't we turn this file into a web page?  Is there some environment
where URL text automatically becomes a link?  Maybe with Javascript?
Ask JC.    We want to preserve the linebreak structure, so this should
be a like a .txt page not a .html page, BUT we want the links to work.

Or maybe write our *own* web client in Python that understands pages
in this format!  Turn it into an edsel mode.  Oh, but we want link to
open page in ordinary HTML or PDF or whatever.  So it has to be
handled by an ordinary browser.

Too bad we haven't been adding links at the top rather than bottom.
Seems we could fix that with some python, just use regexp to find each
date + following text, then reverse order.
...
- <https://mathoverflow.net/questions/43690/whats-a-mathematician-to-do/44213>#44213
  - Bill Thurston's essay in response to "What's a mathematician to
...
-  <https://technicshistory.wordpress.com/2017/09/20/the-electronic-computers-part-2-colossus/>
  - informative and nice page design.

- <https://news.ycombinator.com/item?id=15297861> - John Nagle (Animat)
  comments on Colossus article above, also includes his review of
  1930s 40s 50s special-purpose or non-stored-program
  calculating/computing machines

23 Sep 2017

- various links to bare metal programming on RPi etc. - in
  ~/notes/piety/notes/baremetal.txt
...
-  <https://softwarefoundations.cis.upenn.edu/current/lf-current/Basics.html>
  etc.  New (better) link for 'Coq theorem prover applied to
  programming language theory' in Math/provers.  Also has lots of
  basic tutorial for Coq.

- maybe also add link to GeoCoq (above) for geometry proofs?

- also add link to Freek Wiedijk's Provers of the World (above)
...
- <https://danluu.com/risc-definition/> - What's the definition of RISC? - 
  John Mashey's Usenet posts, already in engr/computer arch as

    CISC and RISC, John Mashey's explanation with detailed comparison of
    many architecture <http://userpages.umbc.edu/~vijay/mashey.on.risc.html>

  BUT danluu version has nicer formatting (HTML not ascii) and more material,
...
- ... 1988 paper Design Philosophy of the DARPA Internet Protocols (now
  on my kindle).
...
n <http://n-gate.com/> - unfunny but voluminous, very repetitous snark
   about HN and FOSDEM.
...
- <https://www.youtube.com/watch?v=qqM3McG4-LE> Saul Bass: Famous title
   sequences from Preminger to Scorsese, 23 movies > 1 hour, linked from
...
- geocoq.github.io/GeoCoq/ also <https://github.com/GeoCoq/GeoCoq> - A
...
X <https://criticalengineering.org/courses/othernet/> also /cli/ /networkshop/
  (Jul 21 2017)

- www.dunneandraby.co.uk/content/bydandr/13/0  Dunne & Raby Critical Design FAQ
  also /content/projects

X Quinns' Revolution in math from 2012 Notices of the AMS, longer
...
X <http://ask.metafilter.com/311380/Other-jazz-standards-like-these-jazz-standards>
...
X <http://www.ps.uni-saarland.de/~hornung/bachelor.php> - 
...
X Webcomics:
  ...
  for example <http://www.octopuspie.com/2007-05-14/001-pea-wiggle/>
 via <http://www.metafilter.com/167893/Its-all-been-eaten-you-cant-have-any-more>
  (21 Jul 2017)
...
- <http://azer.bike/happy-hacking-linux/?t=1>&cn=ZmxleGlibGVfcmVjcw%3D%3D&iid=125f60cc94fa426aae05273eec8f1549&uid=4248633382&nid=244+272699400

(what's with the big url?) - Arch Linux + xmonad etc.   Has cheatsheet
for tiling window manager keybindings.  Site page itself has interesting
minimalist design.   Also noted 22 Jan above.
...
X <http://www.recommendmeabook.com/> - shows first page from 
...
X <https://people.cs.clemson.edu/~mark/uprog.html> - A brief history of
  microprogramming - actually also a very good explanation.
  - Never mind, it's already there in engineering/computer architecgure
...
X <http://www.harkavagrant.com/archivecat.php> - comics
...
X <https://www.nytimes.com/2017/04/14/technology/robert-taylor-innovator-who-shaped-modern-computing-dies-at-85.html?_r=0> 
...
X JC Google+ digital humanities page
11 Apr 2017
...
X <https://bookillustrations.quora.com/> via Mefi post, for example
...
X <https://i.redd.it/uaab4tb56soy.png>
...
X jvns.ca/blog/2017/03/26/bash-quirks - nice brief summary of the
...
X <https://www.behance.net/gallery/50164479/WHOS-AFRAID-OF-RED-YELLOW-AND-BLUE>
...
- <http://www.codersnotes.com/notes/a-constructive-look-at-templeos/>
   - to add to TempleOS entry in precursors.md
   Also <https://news.ycombinator.com/item?id=8658283> long HN thread
   years ago - on second thought, let's not, it focuses on his illness.
...
X <http://www.poster.pl/polish_poster_artists.html>
23 Mar 2017
...
- <http://selfie.cs.uni-salzburg.at/> - maybe, look at the book at github first.
   also <https://github.com/cksystemsteaching/selfie> - Nah ...
...
- Atlas Obscura in graphics/unusual media (for example recent article
   on Japanese internment art)
...
- <http://dev.stephendiehl.com/numpile/> 
  ...
  - LLVM specializer for scientific Python code - very nice writeup
    nice contrast to tailbiter above, which also starts with Python AST
 adjus.Already in Piety/doc/languages.md
...
- Links to CPython and its standard library at Github.
 ...
 16 Apt 2017 but not HN comments

- <https://news.ycombinator.com/item?id=13684339>
    HN comment on piping editor regions through shell commands- oh, see above
...
X seen on HN, Mike Pall (of LuaJIT) on Reddit, recommended reading
  order for Lua C source. (24 Feb 2017)

X www.collectorsweekly.com - several recent via HN - add in graphics/unusual media
  (23 Feb 2017)

16 Feb 2017

X seen on HN, github repo with *transcript* of Rich Hickey's Simple Made Easy talk.
   same repo has other transcripts (24 Feb 2017)

15 Feb 2017

X <http://blog.presentandcorrect.com/category/books> - in graphics/unusual media
   (look for categories menu widget at the bottom of the page) (23 Feb 2017)

- That computing version of Brian Eno's oblique strategies in programming/heuristics

X <https://news.ycombinator.com/item?id=13590305> 
  That HN comment on Unix simplicity, just processes and file descriptors, along
   with riposte on how it's become so complicated.(24 Feb 2017)

- <https://www.reddit.com/r/AskHistorians/>

 9 Feb 2017

X <http://code-poetry.com/>  In typography
  (24 Feb 2017)
...
X <https://pdos.csail.mit.edu/6.828/2016/xv6/book-rev9.pdf> xv6 book 
  Already present in programming/design examples/unix but
  replace -rev7.pdf with -rev9.pdf (24 Feb 2017).
...
X <http://ask.metafilter.com/305199/I-need-a-python-script-that-will-run-a-script>
...
X <https://github.com/PDP-10/its> - Incompatible Timesharing System, code and docs
  (26 Jan 2017)
...
X <https://github.com/ChrisPenner/rasa>  Rasa editor in Haskell
  detailed guide to the code: <https://news.ycombinator.com/item?id=13395941>
  (17 Jan 2017)

13 Jan 2017

X <http://crna.cc/b/11> Blobless Linux on Raspberry Pi 
...
X  A multiple tab terminal emulator implemented in python
...
X Containers from Scratch in great faiths/linux/containers
  (17 Jan 2017)

X Ukelele tuner in Python, uses numpy, pyaudio.
  (26 Jan 2017)
...
X MA single-window minimal acme clone in Tcl/Tk
  <http://www.call-with-current-continuation.org/ma.tar.gz>
  in editors/acme
  (17 Jan 2017)

X christinaa/LLVM-VideoCore4 + HN comments in RPi hacking
   via HN comments on Tourist Guide to LLVM from Reger's blog.
  (16 Jan 2017)

X 9Fans post on Facebook done right, in Plan 9 style.
  (16 Jan 2017)
...
X Added Little Book of OS Development and HN comments to Piety/doc/precursors.md


29 Dec 2016

X Add to link in history <http://davidad.github.io/blog/2014/03/12/the-operating-system-is-out-of-date/>
  "I find that all the significant concepts in software systems were invented/discovered in  the 15 years between 1955 and 1970." add links to HN discussion:
...
X Malory project <http://www.maloryproject.com/about.php> in typography,
  <http://dodecaglotta.com/> in typography (2 Jan 2017)

X Bringup history of Mac OS X (via HN) at www.pagetable.com in great
  faiths/mac (2 Jan 2017)

- Piety precursors.md: github.com/haskus/haskus-system www.haskus.org www.vipervm.org
  "provide a full Haskell user-space environment on top of the Linux kernel"

X <http://littleosbook.github.io/> and maybe HN discussion at bottom of Piety precursors.org


26 Dec 2016

X Why Python is not my favorite programming language in Python assessment.
  <https://zenhack.net/2016/12/25/why-python-is-not-my-favorite-language.html>
  (2 Jan 2017)

X HN post on OLPC compared to RPi  <https://news.ycombinator.com/item?id=13258261>
  esp. View Source for any application and ad-hoc networking with wireless neighbors.
  Maybe in Sugar/OLPC entry in precursors.md - ? (31 Dec)

X PicoLisp tutorial <http://software-lab.de/doc/tut.html> including built-in vi-like editor
  oK tutoril <https://github.com/JohnEarnest/ok> with useful REPL commands
  Both of these in Piety/doc/other.md (31 Dec)
...
X Apple ][ emulation on AVR microcontroller, seen on HN (1 Jan 2017)
...
X Aboriginal Linux "builds the smallest/simplest linux system capable
...
x ok (APL-like) <https://github.com/JohnEarnest/ok> Don't we
  already have this in language arcana/APL? No, I think that's his
  .../ike (31 Dec, Piety/doc/other.md)

X Z acme-inspired editor in scala <https://github.com/sandgorgon/z> (31 Dec)
...
- github.com/doorbell88/Aquarium - runs in mac terminal - maybe
...
n youtube video, Monty Python for Pythonistas
...
X HN comment "Python has gotten hard to learn" in Python assessment (2 Jan 2017)
...
X HN comments praising Lotus Notes in Nostalgia (2 Jan 2017)

X code-poetry.com (23 Feb 2017)

X NLP in Python example, Pride and Prejudice, in Python examples (2 Jan 2017)
...
X Ancient languages in 10 lessons at www.openculture.com/2014/01/learn-latin....
  in literature/history Latin Greek Old English etc.


12 Dec 2016

X for Piety utilities.md <https://github.com/jmcgeheeiv/pyfakefs> via HN 
...
- Claude Shannon's methods and accomplishments, lecture by Robert Gallager
  "Shannon's genius lay in finding the "right way", the "simple way" to look
  at everyday technical problems"
  "Searching for simplicity is really searching for intuitive understanding
  of a simplified version of the problem that doesn't ignore the underlying
  original issues"
  "Graduate students often mistake simplicity for triviality .. The misconception
  is that it takes the best students to solve the most complex problems.  Actually,
  it takes the best students to *find* the simplest open problems."

  www.rle.mit.edu/rgallager/documents/BooleShannon.pdf

- In Piety precursors.md: Xerox Alto simulators, SALTO and Contralto


8 Dec 2016

X Python 3 module of the week <https://pymotw.com/3/>


7 Dec 2016

X Andrew Wiles interview w/HN comments, also video documentary on FLT
...
x ed clone in Haskell via HN Actually Using ed post

x original ed-in-C from V6 Unix at tuhs.org via HN Actually Using ed post
  Oh, we already have this, but maybe revise explanation in following parens.

x Eli Benderski's blog, eli.thegreenplace.net/archives/all via HN post
...
n CRSR blog, <https://manignosis.crsr.net/archive.html> via ed clone in Haskell.
  (He recommends The Programming Historian, mentioned above)


3 Dec 2016

X Terry Tao's career advice, add another link to his blog links
  already in math/buzz (done), also add to education (not done, leave it)
...
- for math/provers, The Incredible Proof Machine with links to other
   pedagogical provers.
...
n Understanding Academic Medical Centers: Simone's Maxims from
...
X Fix Butler Lampson links in programming/history - .htm not .html

X Julia Evans' drawings at drawings.jvns.ca (revise existing link)
  (1 Jan 2017)
X also add to Geek culture/cartoons
  (21 Jul 2017)
- maybe with Sacha Chua's emacs drawings


23 Nov 2016

X Unix history repository  <https://github.com/dspinellis/unix-history-repo>


21 Nov 2016

X python3 faq at <https://eev.ee/blog/>


18 Nov 2016

n Chris Wellons' blog 'null program'


17 Nov 2016

X old Guy Steel-edited Jargon file, preceding ESR's versions
...
X Julia Evans' Linux drawings - along with her earlier zines and cartoons
  <http://jvns.ca/blog/2016/11/10/a-few-drawings-about-linux/>

X Alex Cagan's drawings from scientific conferences


 9 Nov 2016

n github page on Mac OS X security/privacy


 7 Nov 2016

n history of select (in trivium, christian neukirchen blog)

- for precursors.md: goose, bare metal bootloader in Go, github,
  linked in todays HN

- for precursors.md: Synthesis OS (Alexia Masselin's 1992 thesis), sighted
   in Medium article linked on HN


 4 Nov 2016

n Hank Levy's Capabilities book, to go with HN post object refs are
  capabilities.   Later - skip the HN post, it's wrong.  But Levy's
  chapter 1 might be of historic interest, in computer architecture.

X Eric Demaine's MIT 6.851 Advanced Data Structures with wonderful
  hand-drawn notes and diagrams

- DIY $100 laptop (install Ubuntu on old Nexus 7 tablet, add separate kb)

n emacs 40th anniversary post

n cool symbol picker linked by Nelson Minar


 3 Nov 2016

X Dan Luu blog, danluu.com

X other guy's not blog but collection of old Usenet posts etc.
  Was that Kragen or Kraken?  It's Norman Yarvin

n Ask MeFi computers, tech.  Any way to show Mefi Blue tech posts?

X Julia Evans' explanations of containers (2 blog postings)

n HN comment explaining capabilities as just object references.
  BUT they are not!  Object references do not include permissions,
  nor are they unique across all time, so they can't be used to
  identify objects in secondary storage.

n HN comment responding to Mary Rose Cooks' gitlet


 2 Nov 2016

- Pioneers computer history website - similar to 'awesome programmers'
   but with graphics - add them both at same time.  Same authors?
...
X twistedpython blog post explaining containers
  (X maybe add twistedpython to blogs also)

X HN comment thread on editor programming how-tos

- pocoo blog post and HN thread, Python 3.x async critique

X Mary Rose Cook minimal d3 implemention next to older d3 link.
...
X Larry Breed's story in Vector (APL newsletter) on IBM Elsie next to
...
X Mary Rose Cook blog


25 Oct 2016

X AskMe post on bad scientists

- HN thread on Internet rabbit holes

n Joe Armstrong's post on Erlang and GUIs
...
Key:  - to add   X x done   n don't bother  ?- Good candidate to add

X JC find, 'awesome' Python stuff at github - in programming/python

X My find, list of 'awesome programmers' - people and systems in computing
...
X Graphic on music services payments to musicians,

X Resonate music streaming cooperative platform

X Minimal Raspberry Pi VPU firmware

- Essay on Mochizuki's IUT in math/(what?)

X Bauer's essay on constructive math in math/foundations
...
X JC find, awesome python applications/libraries

X mu Python editor for small systems
  (18 Jan 2017)

Add in language.md

X lptrace , function tracer using language injection
  (18 Jan 2017)
  It would be a tour-de-force if we could get lptrace to
  write to an ed.py buffer.  Later: NOT possible, because
  it patches the running python interpreter, there is only
  one running interpreter and nothing else in all Piety.
