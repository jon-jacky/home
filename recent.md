...
- <http://doc.cat-v.org/plan_9/misc/ubiquitous_fileserver/ubiquitous_fileserver.pdf> - "The Ubiquitous File Server in Plan 9 ... 
  ...
  follow) ... (Other examples) domain name service ...  connection
...
- <http://doc.cat-v.org/plan_9/misc/dead_OSes_still_matter/login.pdf> - "Why some dead OSes still matter - 
  Plan 9 does not have an equivalent to the *ioctl()* system call,
  which cannot be isued across a network owing to the reliance on a
  local pointer to pass data.  Instead most servers by convention
  serve a file named *ctl* at the top of their hierarchy, which
  allows clients to control not only I/O but the general behavior of
  the servers."
...
- <http://doc.cat-v.org/bell_labs/the_hideous_name/the_hideous_name.pdf> - "The Hideous Name - 
  ...
  have ordinary file properties such as protection. ... Because these
  unusual objects have regular names, existing tools can treat them as
  files, so standard software can provide services for them that would
  otherwise require special handling. ... When machines are connected
  together, their name spaces may be joined to facilitate the sharing
  of files.  If the name spaces have the same clean structure, that
  structure can be extended simply to describe the larger space.
...
- www.collectorsweekly.com - several recent via HN - add in graphics/unusual media
  (23 Feb 2017)
...
- <http://blog.presentandcorrect.com/category/books> - in graphics/unusual media
...
- Added Little Book of OS Development and HN comments to Piety/doc/precursors.md


29 Dec 2016

- Add to link in history <http://davidad.github.io/blog/2014/03/12/the-operating-system-is-out-of-date/>  "I find that all the significant concepts in software systems were invented/discovered in  the 15 years between 1955 and 1970." add links to HN discussion:
...
- <http://www.maloryproject.com/about.php> Malory project in typography,
...
- <http://littleosbook.github.io/> and maybe HN discussion at bottom of Piety precursors.org
...
- Apple ][ emulation on AVR microcontroller, seen on HN (1 Jan 2017)
...
- ok (APL-like) <https://github.com/JohnEarnest/ok> Don't we
  already have this in language arcana/APL? No, I think that's his
  .../ike (31 Dec, Piety/doc/other.md)

- Z acme-inspired editor in scala <https://github.com/sandgorgon/z> (31 Dec)
...
- HN comment "Python has gotten hard to learn" in Python assessment (2 Jan 2017)
...
- HN comments praising Lotus Notes in Nostalgia (2 Jan 2017)

- code-poetry.com (23 Feb 2017)
...
- Ancient languages in 10 lessons at www.openculture.com/2014/01/learn-latin....
  in literature/history Latin Greek Old English etc.


12 Dec 2016

- for Piety utilities.md <https://github.com/jmcgeheeiv/pyfakefs> via HN 
...
- Terry Tao's career advice, add another link to his blog links
...
- Fix Butler Lampson links in programming/history - .htm not .html

- Julia Evans' drawings at drawings.jvns.ca (revise existing link)
  (1 Jan 2017)
- also add to Geek culture/cartoons
  (21 Jul 2017)
...
- python3 faq at <https://eev.ee/blog/>


18 Nov 2016

- Chris Wellons' blog 'null program'


17 Nov 2016

- old Guy Steel-edited Jargon file, preceding ESR's versions
...
- Julia Evans' Linux drawings - along with her earlier zines and cartoons
  <http://jvns.ca/blog/2016/11/10/a-few-drawings-about-linux/>

- Alex Cagan's drawings from scientific conferences
...
- Eric Demaine's MIT 6.851 Advanced Data Structures with wonderful
...
- Dan Luu blog, danluu.com

- other guy's not blog but collection of old Usenet posts etc.
  Was that Kragen or Kraken?  It's Norman Yarvin

n Ask MeFi computers, tech.  Any way to show Mefi Blue tech posts?

- Julia Evans' explanations of containers (2 blog postings)
...
- Mary Rose Cook minimal d3 implemention next to older d3 link.
