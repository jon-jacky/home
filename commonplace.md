...
- <https://www.exolymph.news/2017/07/27/alternate-computer-universes/> -
  ...
  <https://en.wikipedia.org/wiki/Canon_Cat> also
  <https://en.wikipedia.org/wiki/Archy> and
  <https://github.com/MySheep/Archy/> "Command names can be inserted and
  ...
  functionality related to their common task ... not restricted to
  ... a single application ... (they) can be used system-wide ..."
