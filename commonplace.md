...
- <http://www.laffpix.com/howtoreadnancy.pdf> - How To Read Nancy by Mark
  ...
  (after four pages of analysis of a three-panel strip) ... (These panels)
  were designed to hold (and hold back) a specific gag created on a certain
  day by a certain artist to be read for a laugh in a twinkling of an eye
  on another certain day by a few certain million people.  Form follows
  function of the strip.  You can't strip it down more than this folks."
