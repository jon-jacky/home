...
- <https://gigatron.io/> - Gigatron TTL Microcomputer - 
  Microcomputer including video output made from about 40 TTL "glue logic" chips.
  No microprocessor, not even a 74181 ALU due to its complexity and rarity,
  but a custom ALU made of multiplexers and adders.
  No video processor, but 160 x 120 pixels in 64 colors generated by the main
  processor, adapted to 640 x 480 VGA by 4x pixel and scan line replication.
  6.25 MHz, 32K x 8 RAM, 64K x 16 EEPROM. Detailed explanations on their FAQ page.
  ...
  Compare to BASIC Engine 6 Jul 2018 and Uzebox 24 May 2018,
  similar functionality but with microprocessors, and Pong 11 Jun 2018,
  single-purpose device with no microprocessor and 66 TTL chips.
