...
- *Measurement* by Paul Lockhart, pages 1, 5, 50, 32-33, 36-37, 42-45, 125-127
  ...
  This book is a self-contained re-intoduction to mathematics from geometry
  through calculus and differential equations, from a particular personal
  point-of-view.  Much of its mathematical content is too long and too
  interdependent to excerpt here.
...
- *Mathematics: A Very Short Introduction* by Timothy Gowers, preface,
  ...
  *x^(a+b) = x^a x^b*.   If this rule has been emphasized, then not
  ...
  This book is not online but the author has some similar material here:
