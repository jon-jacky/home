...
- <https://tools.ietf.org/html/rfc1180> - "RFC 1180, A TCP/IP Tutorial"
  ASCII-only RFC converted to HTML, still in typewriter font
  but with internal and external hyperlinks.
  Use *[txt]* and *[pdf]* links to see those formats, use *[Docs]* link
  to reach the home page for other IETF documents including all the RFCs,
  for example <https://tools.ietf.org/html/rfc871>, "A Perspective on the 
